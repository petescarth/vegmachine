...
! function(t, i) {
  ...
  function y(t) {
    if (L && L.Evented) {
      t = ei(t) ? t : [t];
      for (var i = 0; i < t.length; i++) t[i] === L.Evented.prototype && console.warn("Deprecated include of L.Mixin.Events: this property will be removed in future releases, please inherit from L.Evented instead.", (new Error).stack)
    }
  }
